...
struct PersistenceController {
    ...
    private func seedInitialData() {
        if UserDefaults.standard.bool(forKey: Self.hasSeededDataKay) {
            return
        }
        ...
        do {
            try context.save()
            UserDefaults.standard.set(true, forKey: PersistenceController.hasSeededDataKay)
        } catch {
            print("Failed to seed initial data:", error)
        }
    }
    static let hasSeededDataKay = "hasSeedData"
}
